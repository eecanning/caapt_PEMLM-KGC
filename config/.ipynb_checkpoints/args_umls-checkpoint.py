...
def get_args():
    ...
    parser.add_argument('--train_result_json_path', type=str,default='log/umls_train_base.json', help='train_result_json_path')
    parser.add_argument('--valid_result_json_path', type=str,default='log/umls_valid_base.json', help='valid_result_json_path')
    parser.add_argument('--test_result_json_path', type=str,default='log/umls_test_base.json', help='test_result_json_path')
