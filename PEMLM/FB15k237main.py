...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_path', type=str, default='parameter/FB15k237_reverse.pth', help='model_weight_path')
    parser.add_argument('--model_path', type=str, default='model/bert-base-uncased-model', help='original model path')
    parser.add_argument('--embedding_path', type=str, default='model/Fb15k237_word_embeddings_reverse.pt', help='UMLS embedding path')
    ...
    parser.add_argument('--train_result_json_path', type=str,default='log/FB15K237_train_result_reverse.json', help='train_result_json_path')
    parser.add_argument('--valid_result_json_path', type=str,default='log/FB15K237_valid_result_reverse.json', help='valid_result_json_path')
    parser.add_argument('--test_result_json_path', type=str,default='log/FB15K237_test_result_reverse.json', help='test_result_json_path')
