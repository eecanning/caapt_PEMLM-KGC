...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_result_json_path', type=str, default='log/WN18RR_train_combinehr.json',
                        help='train_result_json_path')
    parser.add_argument('--valid_result_json_path', type=str, default='log/WN18RR_valid_combinehr.json',
                        help='valid_result_json_path')
    parser.add_argument('--test_result_json_path', type=str, default='log/WN18RR_test_combinehr.json',
